...
### Backend
- Node.js - Nest.js - Express.js - REST APIs - Authentication and authorization  

I design backend services with clean APIs and predictable data flow.

### Full-stack (MERN)
- MongoDB - Express.js - React - Node.js - AWS - Devops
...
- I design for scale and clarity  
- I keep logic simple and explicit  
...
My pinned repositories demonstrate:
